...
<template>
  <div class="menu">
    ...
    <div class="menu-item">
      ...
      <div class="menu-item__superscript" title="上标" @click="executeSuperscript">
    ...
    <div class="menu-item">
      ...
      <div :title="`左对齐(${isApple ? '⌘' : 'Ctrl'}+L)`" class="menu-item__left" @click="executeLeft">
        <UiwWordLeft></UiwWordLeft>
      </div>
      <div :title="`居中对齐(${isApple ? '⌘' : 'Ctrl'}+E)`" class="menu-item__center" @click="executeCenter">
        <UiwWordCenter></UiwWordCenter>
      </div>
      <div :title="`右对齐(${isApple ? '⌘' : 'Ctrl'}+R)`" class="menu-item__right" @click="executeRight">
        <UiwWordRight></UiwWordRight>
      </div>
      <div :title="`两端对齐(${isApple ? '⌘' : 'Ctrl'}+J)`" class="menu-item__alignment" @click="executeAlignment">
        <UiwWordAlignment></UiwWordAlignment>
      </div>
      <div class="menu-item__row-margin" title="行间距" @click="rowMarginClick">
      ...
      <div class="menu-item__list" title="列表" @click="listClick">
        ...
        <div class="options" @click="listChange($event)">
          <ul>
            ...
            <li data-list-style="decimal" data-list-type="ol">
              <label>有序列表：</label>
              <ol>
                <li>________</li>
              </ol>
            </li>
            <li data-list-style="checkbox" data-list-type="ul">
              <label>复选框列表：</label>
              <ul style="list-style-type: '☑️ '">
                <li>________</li>
              </ul>
            </li>
            <li data-list-style="disc" data-list-type="ul">
              <label>实心圆点列表：</label>
              <ul style="list-style-type: disc">
                <li>________</li>
              </ul>
            </li>
            <li data-list-style="circle" data-list-type="ul">
              <label>空心圆点列表：</label>
              <ul style="list-style-type: circle">
                <li>________</li>
              </ul>
            </li>
            <li data-list-style="square" data-list-type="ul">
              <label>空心方块列表：</label>
    ...
    <div class="menu-item">
      ...
      <div class="menu-item__image" title="图片" @click="imageClick">
        ...
        <input id="image" accept=".png, .jpg, .jpeg, .svg, .gif" type="file"/>
      </div>
      <div
      ...
      <div class="menu-item__date" title="日期" @click="dateClick">
    ...
    <div>
      ...
      <div class="page-mode" title="页面模式(分页、连页)" @click="pageModeClick">
        ...
        <div class="options" @click="pageModeChange($event)">
          <ul>
            <li class="active" data-page-mode="paging">分页</li>
    ...
    <div>
      ...
      <div class="paper-size" title="纸张类型" @click="paperTypeClick">
        ...
        <div class="options" @click="paperTypeChange($event)">
          <ul>
            <li class="active" data-paper-size="794*1123">A4</li>
      ...
      <div class="paper-direction" title="纸张方向" @click="paperDirectionClick">
        ...
        <div class="options" @click="paperDirectionChange($event)">
          <ul>
            <li class="active" data-paper-direction="vertical">纵向</li>
  ...
  <input id="file-docx" accept=".docx" name="file-docx" style="display: none" type="file"/>
  <!-- #region 超链接-->
  <DragModal
      :border="false"
  ...
  >
    <a-form ref="hyperlinkFormRef" :labelCol="{ style: 'width: 80px' }" :model="hyperlink">
      <a-form-item :rules="[{ required: true }]" label="文本" name="hyperlinkUrl">
        <a-input v-model:value="hyperlink.hyperlinkUrl" placeholder="文本"/>
      </a-form-item>
      <a-form-item :rules="[{ required: true }]" label="链接" name="hyperlinkText">
  ...
  >
    <a-form ref="watermarkFormRef" :labelCol="{ style: 'width: 80px' }" :model="watermark">
      <a-form-item :rules="[{ required: true }]" label="内容" name="content">
        <a-input v-model:value="watermark.content" placeholder="请输入内容"/>
      </a-form-item>
      <a-form-item :rules="[{ required: true }]" label="颜色" name="color">
        <color-picker v-model:pureColor="watermark.color" format="hex"/>
      </a-form-item>
      <a-form-item :rules="[{ required: true }]" label="字体大小" name="fontSize">
  ...
  >
    <a-form ref="codeBoxFormRef" :labelCol="{ style: 'width: 80px' }" :model="codeBox">
  ...
  <!-- #endregion -->
  <!-- #region LateX-->
  <DragModal :border="false" :visible="latexVisible" :width="500" title="LaTeX" @close="() => (latexVisible = false)">
    <a-form ref="latexBoxFormRef" :labelCol="{ style: 'width: 80px' }" :model="latexBox">
  ...
  >
    <a-form ref="controlboxFormRef" :labelCol="{ style: 'width: 80px' }" :model="controlbox">
      <a-form-item
  ...
  >
    <a-form ref="contentBlockFormRef" :labelCol="{ style: 'width: 80px' }" :model="contentBlock">
      <a-form-item :rules="[{ required: true }]" label="类型" name="type">
      ...
      <a-form-item :rules="[{ required: true }]" label="高度" name="hight">
  ...
  >
    <a-form ref="pageMarginFormRef" :labelCol="{ style: 'width: 80px' }" :model="pageMargin">
      <a-form-item :rules="[{ required: true }]" label="上边距" name="top">
        <a-input v-model:value="pageMargin.top" placeholder="请输入上边距"/>
      </a-form-item>
      <a-form-item :rules="[{ required: true }]" label="下边距" name="bottom">
        <a-input v-model:value="pageMargin.bottom" placeholder="请输入下边距"/>
      </a-form-item>
      <a-form-item :rules="[{ required: true }]" label="左边距" name="left">
        <a-input v-model:value="pageMargin.left" placeholder="请输入左边距"/>
      </a-form-item>
      <a-form-item :rules="[{ required: true }]" label="右边距" name="right">
  ...
  >
    <a-form ref="editorOptionFormRef" :labelCol="{ style: 'width: 80px' }" :model="editorOption">
      <a-form-item :rules="[{ required: true }]" label="编辑器配置" name="content">
...
<script setup>
import Editor, {BlockType, ControlType, EditorMode, ElementType, RowFlex, splitText} from '@hufe921/canvas-editor'
